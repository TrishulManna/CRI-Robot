                        ...
                        <table class="table table-striped">
                            ...
                            <?php $__currentLoopData = $behaviors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $behavior): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                <tr class="bhv-row" id="bhv-id-<?php echo e($behavior->id); ?>">
                                    ...
                                    -->
                                    <th>
                                        <a href="<?php echo e(route('BehaviorsController.approved', $behavior->id)); ?>" class="btn btn-success response" style="<?php if($behavior->accepted == 1): ?>display: none; else display: block;<?php endif; ?>">
                                        <i class="fa fa-check"></i> Approve</a>

                                        <a href="<?php echo e(route('BehaviorsController.declined', $behavior->id)); ?>" class="btn btn-danger response"
                                        style="<?php if($behavior->accepted == 1): ?>display: none; else display: block;<?php endif; ?>">
