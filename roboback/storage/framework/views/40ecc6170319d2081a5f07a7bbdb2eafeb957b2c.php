                    ...
                    <div class="panel-body">
                        ...
                        <table class="table table-striped">
                            ...
                            <?php $__currentLoopData = $robots; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $robot): $__env->incrementLoopIndices(); $loop = $__env->getFirstLoop(); ?>
                                <?php if($robot->user_id == Illuminate\Support\Facades\Auth::id() || (bool)App\RoleUsers::where('user_id', Illuminate\Support\Facades\Auth::id())->where('role_id', 1)->first() || (bool)App\RoleUsers::where('user_id', Illuminate\Support\Facades\Auth::id())->where('role_id', 2)->first()): ?>
                                    <tr>
