                        ...
                        <table class="table table-striped">
                            ...
                            @foreach ($behaviors as $behavior)
                                <tr class="bhv-row" id="bhv-id-{{ $behavior->id }}">
                                    ...
                                    -->
                                    <th>
                                        <a href="{{ route('BehaviorsController.approved', $behavior->id) }}" class="btn btn-success response" style="@if($behavior->accepted == 1)display: none; else display: block;@endif">
                                        <i class="fa fa-check"></i> Approve</a>

                                        <a href="{{ route('BehaviorsController.declined', $behavior->id) }}" class="btn btn-danger response"
                                        style="@if($behavior->accepted == 1)display: none; else display: block;@endif">
